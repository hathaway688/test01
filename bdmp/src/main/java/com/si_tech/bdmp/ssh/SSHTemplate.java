...
/**
 * 
 * <p>Title: SSHTemplate</p>
 * <p>Description: SSH操作模板类</p>
 * <p>Copyright: Copyright (c) 2019</p>
 * <p>Company: 思特奇 </p>
 * @author heweia
 * @version 1.0
 * @createtime 2019-4-9 上午9:13:02
 *
 */
public class SSHTemplate {
	...
	public Result execute(String ip, SSHCallback callback) throws SSHException{
		return execute(ip,BaseConstant.DEFAULT_SSH_PORT_DEFAULT, BaseConstant.USERNAME, 
				BaseConstant.PASSWORD, callback);
	}
    ...
    public class SSHSession{
    	 ...
    	 * @throws IOException
    	 */
    	public Result scp(String localFiles, long length, String remoteTargetDirectory, String mode) {
    		try {
    			SCPClient client = conn.createSCPClient();
				client.put(localFiles, length, remoteTargetDirectory, mode);
				return new Result(true);
			} catch (Exception e) {
				logger.error("scp local="+localFiles+" to "+
						remoteTargetDirectory+" long="+length+" err", e);
				return new Result(e);
			}
    	}
...
/*    	public Result scpToDir(String localFile, String remoteTargetDirectory) {
    	...
    	public Result scpToDir(String localFile, String remoteTargetDirectory, String mode) {
    		return scp( localFile, null, remoteTargetDirectory, mode);
    	}
